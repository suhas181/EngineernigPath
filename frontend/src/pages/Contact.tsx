      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-12 md:py-16 space-y-10 w-full">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1 space-y-4">
            <div className="p-6 rounded-2xl bg-[#0D131F] border border-white/10 space-y-4">
              <div className="p-3 rounded-xl bg-teal-500/10 text-teal-400 border border-teal-500/20 w-fit">
                <Mail className="h-5 w-5" />
              </div>
              <div>
                <h2 className="text-base font-bold text-white">Direct Email</h2>
                <p className="text-xs text-slate-400 mt-1">
                  For inquiries, platform feedback, and support:
                </p>
                <a
                  href={`mailto:${siteConfig.contactEmail}`}
                  className="text-sm text-teal-400 hover:text-teal-300 font-medium break-all mt-2 inline-block transition"
                >
            ...
            <div className="p-6 rounded-2xl bg-[#0D131F] border border-white/10 space-y-3">
              ...
              {siteConfig.socialLinks.github && (
                <a
                  ...
                  className="text-xs text-teal-400 hover:underline inline-block pt-1"
                >
          ...
          <div className="md:col-span-2">
            <div className="p-6 md:p-8 rounded-2xl bg-[#0D131F] border border-white/10">
              {submitted ? (
                <div className="text-center py-10 space-y-4">
                  <div className="p-3 rounded-full bg-teal-500/20 text-teal-400 w-fit mx-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-xl px-3.5 py-2.5 text-sm text-white placeholder:text-slate-500 focus:outline-none focus:border-teal-500/50"
                      />
                    </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <textarea
                      ...
                      className="w-full bg-white/5 border border-white/10 rounded-xl px-3.5 py-2.5 text-sm text-white placeholder:text-slate-500 focus:outline-none focus:border-teal-500/50 resize-none"
                    />
                  </div>

                  <button
                    type="submit"
                    className="mosaic-btn-brand w-full flex items-center justify-center space-x-2 !py-3"
                  >
