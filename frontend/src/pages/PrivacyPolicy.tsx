...
export function PrivacyPolicy() {
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-[#101826] text-slate-700 dark:text-slate-300 font-sans transition-colors duration-200">
      {/* Top Header */}
      ...
      {/* Main Content Area */}
      <main className="flex-1 max-w-4xl mx-auto px-6 py-12 md:py-16 space-y-10 w-full text-slate-600 dark:text-slate-300 text-sm md:text-base leading-relaxed">
        {/* Header */}
        ...
        {/* Introduction */}
        <section className="p-6 md:p-8 rounded-2xl bg-white dark:bg-[#0D131F] border border-slate-200 dark:border-white/10 shadow-sm space-y-4">
          <h2 className="text-lg md:text-xl font-bold text-slate-900 dark:text-white font-heading flex items-center space-x-2">
        ...
        <section className="p-6 md:p-8 rounded-2xl bg-white dark:bg-[#0D131F] border border-slate-200 dark:border-white/10 shadow-sm space-y-4">
          ...
          <div className="space-y-3 text-xs md:text-sm">
            <div>
              <strong className="text-slate-900 dark:text-white font-semibold block">A. Account Information:</strong>
            ...
            <div>
              <strong className="text-slate-900 dark:text-white font-semibold block">B. Resume & Career Documents:</strong>
            ...
            <div>
              <strong className="text-slate-900 dark:text-white font-semibold block">C. Platform Activity & History:</strong>
            ...
            <div>
              <strong className="text-slate-900 dark:text-white font-semibold block">D. Authentication Tokens:</strong>
        ...
        <section className="p-6 md:p-8 rounded-2xl bg-white dark:bg-[#0D131F] border border-slate-200 dark:border-white/10 shadow-sm space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2 text-xs md:text-sm pl-2">
            <li>
              <strong className="text-slate-900 dark:text-white">MongoDB Atlas:</strong> Managed cloud database for user profiles, curriculum content, and platform activity data.
            </li>
            <li>
              <strong className="text-slate-900 dark:text-white">Cloudinary:</strong> Secure cloud asset storage used for persisting uploaded resume files in production.
            </li>
            <li>
              <strong className="text-slate-900 dark:text-white">Adzuna Job API:</strong> Aggregated search engine used for fetching external internship opportunities. No user personal data is transmitted to Adzuna.
            </li>
            <li>
              <strong className="text-slate-900 dark:text-white">AI Services (Google Gemini / NVIDIA NIM):</strong> Utilized for resume OCR extraction and dynamic curriculum generation.
            </li>
            <li>
              <strong className="text-slate-900 dark:text-white">Hosting Platforms (Render / Vercel):</strong> Application backend runtime execution and global frontend content delivery.
            </li>
          </ul>
        </section>
        ...
        <section className="p-6 md:p-8 rounded-2xl bg-white dark:bg-[#0D131F] border border-slate-200 dark:border-white/10 shadow-sm space-y-4">
          ...
          <p className="text-xs md:text-sm">
            ...
            <a href={`mailto:${siteConfig.contactEmail}`} className="text-teal-600 dark:text-teal-400 hover:underline">
        ...
        {/* Contact Information */}
        <section className="p-6 rounded-2xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 shadow-sm space-y-2 text-xs md:text-sm">
          <h3 className="font-bold text-slate-900 dark:text-white text-sm">Questions Regarding Privacy</h3>
          <p>
            For any inquiries regarding this Privacy Policy, contact us at{' '}
            <a href={`mailto:${siteConfig.contactEmail}`} className="text-teal-600 dark:text-teal-400 hover:underline font-medium">
              {siteConfig.contactEmail}
            </a>.
          </p>
        </section>
